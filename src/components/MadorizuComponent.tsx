...
const MadorizuComponent = forwardRef<
  MadorizuComponentRef,
  MadorizuComponentProps
>(({ imageData, markers, onMarkersChange }, ref) => {
  ...
  const handleMouseMove = (e: React.MouseEvent) => {
    ...
    if (isDragging && zoomLevel > 1) {
      ...
      const aspectRatioFactor =
        imageAspectRatio > containerAspectRatio ? 1.5 : 2.0;
    ...
    <div className="madorizu-container">
        ...
        >
          <img
            ...
            style={{
              ...
              transition:
                zoomLevel === 1 ? "width 0.3s ease, height 0.3s ease" : "none",
              userSelect: "none",
              pointerEvents: "auto",
            }}
          />
      ...
      <div>
        {imageWidth > 0 && imageHeight > 0 && (
          ...
          >
            画像サイズ: {imageWidth} × {imageHeight} ピクセル (ズーム:{" "}
            {zoomLevel}x) - マーカー: {markers.length}/20
          </p>
        )}
      </div>
    </div>
